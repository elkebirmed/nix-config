...
{pkgs, ...}: {
  programs.fish = {
    ...
    interactiveShellInit =
      ...
      */
      ''
        ...
        set -x tide_right_prompt_items status cmd_duration jobs direnv newline bun node python rustc java php pulumi ruby go gcloud kubectl distrobox toolbox terraform aws juju nix3_shell crystal elixir zig
    ...
    # Tide custom functions.
    functions = {
      # Prompt item for Juju.
      _tide_item_juju =
        /*
        fish
        */
